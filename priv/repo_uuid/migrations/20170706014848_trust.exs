defmodule Epoch.Repo.Migrations.Trust do
  ...
  def change do
    create table(:trust, primary_key: false) do
      ...
      add :user_id_trusted, references(:users, type: :uuid, on_delete: :delete_all)
      add :type, :smallint
    end
    ...
    create table(:trust_feedback, primary_key: false) do
      add :id, :binary_id, primary_key: true, default: fragment("uuid_generate_v4()")
      add :user_id, references(:users, type: :uuid, on_delete: :delete_all)
      add :reporter_id, references(:users, type: :uuid, on_delete: :delete_all)
