defmodule Epoch.Repo.Migrations.CreateAdminReportsPostsNotes do
  use Ecto.Migration
  @schema_prefix "administration"

  def change do
    create table(:reports_posts_notes, [prefix: @schema_prefix, primary_key: false]) do
      add :id, :binary_id, [primary_key: true, default: fragment("uuid_generate_v4()")]
      add :report_id, references(:reports_posts, type: :uuid, on_delete: :delete_all)
