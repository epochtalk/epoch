defmodule Epoch.Repo.Migrations.AdministrationSchemaConstraints do
  ...
  def change do
    ...
    execute("ALTER TABLE ONLY #{@schema_prefix}.reports_messages ADD CONSTRAINT status_id_fkey FOREIGN KEY (status_id) REFERENCES #{@schema_prefix}.reports_statuses(id)")
